...
Begin VB.Form frmAggiornadep 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Ajourner un Devis Objets d'Occasion"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14460
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   1095
      Left            =   11760
      Picture         =   "frmAggiornadep.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   53
      Top             =   3240
      Width           =   1695
   ...
   Begin VB.CommandButton cmdmemo 
      ...
      Height          =   855
      Left            =   10200
      Picture         =   "frmAggiornadep.frx":1D12
      Style           =   1  'Graphical
      TabIndex        =   34
      Top             =   4320
      Width           =   2295
   ...
   Begin VB.CommandButton Command3 
      ...
      Height          =   735
      Left            =   8520
      Picture         =   "frmAggiornadep.frx":4104
      Style           =   1  'Graphical
      TabIndex        =   32
      Top             =   7680
      Width           =   1935
   ...
   Begin VB.CommandButton cmdback 
      ...
      Height          =   735
      Left            =   10440
      Picture         =   "frmAggiornadep.frx":424E
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   7680
      Width           =   1335
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   735
      Left            =   3600
      Picture         =   "frmAggiornadep.frx":5F90
      Style           =   1  'Graphical
      TabIndex        =   20
      Top             =   720
      Width           =   615
   ...
   Begin MSDataGridLib.DataGrid DataGrid4 
      Bindings        =   "frmAggiornadep.frx":7CA2
      Height          =   855
      Left            =   600
      TabIndex        =   17
      Top             =   7680
   ...
   Begin VB.PictureBox Picture1 
      Height          =   1530
      Left            =   8640
      Picture         =   "frmAggiornadep.frx":7CB7
      ScaleHeight     =   1470
      ScaleWidth      =   3225
      TabIndex        =   13
      Top             =   0
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmAggiornadep.frx":17E39
      Height          =   1935
      Left            =   8400
      TabIndex        =   8
      Top             =   120
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAggiornadep.frx":17E4E
      Height          =   1935
      Left            =   7920
      TabIndex        =   9
      Top             =   240
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "frmAggiornadep.frx":17E63
      Height          =   375
      Left            =   3360
      TabIndex        =   14
      Top             =   7680
   ...
   Begin MSDataGridLib.DataGrid DataGrid5 
      Bindings        =   "frmAggiornadep.frx":17E78
      Height          =   2415
      Left            =   120
      TabIndex        =   33
      Top             =   5160
   ...
   Begin MSDataListLib.DataCombo DataCombo1 
      Bindings        =   "frmAggiornadep.frx":17E8D
      Height          =   360
      Left            =   120
      TabIndex        =   43
      Top             =   4680
   ...
   End
End
Attribute VB_Name = "frmAggiornadep"
...
If Val(txtpezzi) = 0 Then GoTo dopo
  ...
  response = MsgBox("Changer Le Client?", vbOKCancel + vbCancel, "Attenzione")
...
Adodc5.Recordset.Update
  ...
  response = MsgBox("Ajouter le Stock?", vbOKCancel + vbCancel, "Attenzione")
     Select Case response
         Case 6
    'aggiorna giacenza
