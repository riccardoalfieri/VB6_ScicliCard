...
Global messaggi(20) As String
Global somma1, somma2, somm3 As Single
Global SCONTO As String
Global stringa3, stringa4 As String
Global valore_sconto As Single
Global datarow As Integer
Global LINGUA, winproductid, string_conn1, evento As String
Global number_mid As Integer
Global mobile1, archivipagamenti As String
Global azienda, codiceazienda, id_cliente, pw_cliente, cittadina As String
Global campo(4) As String
Global flags(2) As Boolean
