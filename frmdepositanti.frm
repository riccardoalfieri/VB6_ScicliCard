...
Begin VB.Form frmdepositanti 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frmdepositanti.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   600
         Width           =   1215
      ...
      Begin VB.CommandButton cmdUpdate 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frmdepositanti.frx":23F2
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   1200
         Width           =   1215
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frmdepositanti.frx":253C
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   1800
         Width           =   1215
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frmdepositanti.frx":2686
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   2400
         Width           =   1215
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frmdepositanti.frx":2AC8
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   3000
         Width           =   1215
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Height          =   855
         Left            =   7800
         Picture         =   "frmdepositanti.frx":2C12
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   3600
         Width           =   1215
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         UserName        =   ""
         Password        =   ""
         RecordSource    =   "SELECT * FROM DEPOSITANTI ORDER BY Cliente"
         Caption         =   "Adodc1"
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmdepositanti.frx":3054
         Height          =   1455
         Left            =   240
         TabIndex        =   9
         Top             =   6960
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmdepositanti.frx":3069
         DataField       =   "Pagamento"
         DataSource      =   "Adodc1"
         Height          =   315
         Left            =   240
   ...
   End
End
Attribute VB_Name = "frmdepositanti"
...
Randomize
TXTCODE = "DEP" & Round(Rnd() * 999999) & TXTCODE + Chr(Round(Rnd() * 25) + 65)
End Sub
...
If Len(txtName) > 0 And Len(txtlistino) > 0 Then
    ...
    delete
Else
    mb = MsgBox("Saisiè produit ", vbCritical, "Attenzione")
    txtName.SetFocus
End If
...
If Val(txtlistino) < 1 Or Val(txtlistino) > 3 Then
 mb = MsgBox("Nombre 1,2,3", vbCritical, "Attenzione")
   txtlistino = "1"
    End If
End Sub
