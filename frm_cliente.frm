...
Begin VB.Form frm_cliente 
   ...
   ClientTop       =   420
   ClientWidth     =   6555
   Icon            =   "frm_cliente.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   4275
   ScaleWidth      =   6555
   StartUpPosition =   3  'Windows Default
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frm_cliente.frx":50AB0
      Height          =   735
      Left            =   480
      TabIndex        =   9
      Top             =   4320
   ...
   Begin MSDataGridLib.DataGrid DataGrid6 
      Bindings        =   "frm_cliente.frx":50F07
      Height          =   1095
      Left            =   0
      TabIndex        =   0
      Top             =   2280
   ...
   Begin MSAdodcLib.Adodc Adodc6 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frm_cliente.frx":50F1C
      OLEDBString     =   $"frm_cliente.frx":50FA9
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frm_cliente.frx":51036
      OLEDBString     =   $"frm_cliente.frx":510C3
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frm_cliente.frx":51150
      Height          =   1095
      Left            =   0
      TabIndex        =   2
      Top             =   3600
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frm_cliente.frx":51165
      OLEDBString     =   $"frm_cliente.frx":511F2
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
...
'On Error GoTo dopo
If DataGrid1.Columns(3) < valore_sconto Then
 MsgBox "Sconto massimo: € " & DataGrid1.Columns(3), vbInformation, "Transazione NON ESEGUITA"
  Label3.Visible = True
...
If DataGrid6.Columns(0) = art1 Then  ' codice cliente
  If DataGrid6.Columns(1) = art2 Then   'controlla il pin

       If DataGrid6.Columns(5) > DataGrid1.Columns(0) Then ' controlla la scadenza della card
       ...
       DataGrid6.Columns(2) = DataGrid6.Columns(2) - valore_sconto
        DataGrid6.Columns(6) = DataGrid1.Columns(0)  ' data ultima transazione
         Label4 = "Residuo € " & DataGrid6.Columns(2) ' credito residuo cliente
       ...
       Adodc6.Recordset.MoveFirst  ' AGGIORNA CONTO AZIENDA
         ...
         Else
         MsgBox "Card scaduta", vbInformation, "Transazione NON ESEGUITA"
          Label3.Visible = True
      End If
