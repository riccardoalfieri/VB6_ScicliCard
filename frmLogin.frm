...
lingue
 ...
 varia5 = 1143 ' numero di codice del programma
...
Label2.Caption = "Pour recevoir le code d'activation envoyer le code d'installation et Votre Nom à l'e-mail support@alfierisoftware.net"
frmLogin.Caption = "Envoyer code d'installation à support@alfierisoftware.net"
...
Label2.Caption = "To receive the activation code send Installation Code to e-mail support@alfierisoftware.net"
frmLogin.Caption = "Send Installation code to support@alfierisoftware.net"
...
Label2.Caption = "Enviar codigo de l'installacion al email support@alfierisoftware.net para obtenir el código de la activacion. "
frmLogin.Caption = "Enviar codigo d'installacion al support@alfierisoftware.net"
...
Label2.Caption = "Den Aktivierungscode zu erhalten, schicken Sie Genehmigungsnr. support@alfierisoftware.net zu E-mail"
 
frmLogin.Caption = "Schicken Sie die Genehmigungsnr. support@alfierisoftware.net zur E-mail"
